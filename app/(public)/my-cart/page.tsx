      ...
      <main className="max-w-7xl mx-auto px-3 sm:px-4 lg:px-8 py-3 sm:py-4 lg:py-8">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 sm:gap-6 lg:gap-8">
          ...
          <div className="lg:col-span-2 space-y-4 sm:space-y-6">
            ...
            <div className="bg-white rounded-xl p-4 sm:p-6 shadow-sm border border-gray-100">
              <div className="flex flex-col sm:flex-row sm:items-center justify-between space-y-3 sm:space-y-0">
                <div className="flex items-center space-x-3 sm:space-x-4">
                  ...
                  <div>
                    <h2 className="text-base sm:text-lg font-semibold text-gray-900">Local Market</h2>
                    <div className="flex items-center space-x-1 text-gray-600">
                      <MapPin className="w-3 h-3 sm:w-4 sm:h-4" />
                      <span className="text-xs sm:text-sm">Shopping in 07114</span>
                    </div>
                  </div>
                </div>
            ...
            {/* Cart Items */}
            <div className="bg-white rounded-xl p-4 sm:p-6 shadow-sm border border-gray-100">
              <h3 className="text-base sm:text-lg font-semibold text-gray-900 mb-4 sm:mb-6">Items Name</h3>
              ...
              {items.length === 0 ? (
                ...
                <div className="space-y-3 sm:space-y-4">
                  {items.map((item) => (
                    <div key={item.product._id} className="flex flex-col sm:flex-row sm:items-center space-y-3 sm:space-y-0 sm:space-x-4 p-3 sm:p-4 bg-gray-50 rounded-lg">
                      <div className="flex items-center space-x-3 sm:space-x-4">
                        ...
                        <div className="flex-1 min-w-0">
                          <h4 className="text-xs sm:text-sm font-medium text-gray-900 line-clamp-2 sm:truncate">{item.name}</h4>
                          <div className="flex items-center space-x-2 mt-1">
                            {item.originalPrice && (
                              <span className="text-xs sm:text-sm text-gray-400 line-through">{formatPrice(item.originalPrice)}</span>
                            )}
                            <span className="text-xs sm:text-sm font-semibold text-gray-900">{formatPrice(item.price)}</span>
                          </div>
                        </div>
                      </div>
            ...
            <div className="bg-white rounded-xl shadow-sm border border-gray-100 sticky top-20 sm:top-24">
              ...
              <div className="p-4 sm:p-6">
                ...
                <div className="space-y-3 sm:space-y-4">
                  ...
                  <div className="border-t border-gray-200 pt-3 sm:pt-4">
                    <div className="flex justify-between">
                      ...
                      <span className="text-base sm:text-lg font-semibold text-gray-900">{formatPrice(subtotal)}</span>
                    </div>
                  </div>
                </div>
                ...
                >
                  ...
                  <span className="text-base sm:text-md font-semibold">{formatPrice(subtotal)}</span>
                </Button>
              </div>
            </div>
          </div>
        ...
        <div className="mt-8 sm:mt-12">
          <div className="flex items-center justify-between mb-4 sm:mb-6">
            <h2 className="text-lg sm:text-2xl font-bold text-gray-900">Recommendations</h2>
            <div className="flex space-x-1 sm:space-x-2">
              <Button variant="ghost" size="icon" className="text-gray-500 hover:text-gray-600 w-8 h-8 sm:w-10 sm:h-10">
